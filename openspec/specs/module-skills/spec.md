...
Define the structure, scope, and accuracy requirements for module-level `.agent/skills/*/SKILL.md` files so Skill guidance stays aligned with the current codebase.
## Requirements
